...
import com.cnc.qr.security.service.AuditEventService;
...
public class AuditResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the {@link
     * AuditEvent} in body, or status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id:.+}")
