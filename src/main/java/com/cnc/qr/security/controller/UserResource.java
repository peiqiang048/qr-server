...
import com.cnc.qr.common.exception.BadRequestAlertException;
import com.cnc.qr.common.exception.EmailAlreadyUsedException;
import com.cnc.qr.common.exception.LoginAlreadyUsedException;
import com.cnc.qr.common.repository.UserRepository;
import com.cnc.qr.security.service.MailService;
import com.cnc.qr.security.service.UserService;
...
public class UserResource {
     ...
     * } and with body the updated user.
     *
     ...
     */
    @GetMapping("/users/{login:" + RegexConstants.LOGIN_REGEX + "}")
     ...
     */
    @DeleteMapping("/users/{login:" + RegexConstants.LOGIN_REGEX + "}")
    @PreAuthorize("hasRole(\"" + AuthoritiesConstants.ADMIN + "\")")
