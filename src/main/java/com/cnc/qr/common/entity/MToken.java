...
public class MToken implements Serializable {
    ...
    public MToken storeId(String storeId) {
    ...
    public MToken receivablesId(String receivablesId) {
    ...
    public MToken tokenId(String tokenId) {
    ...
    public MToken delFlag(Integer delFlag) {
    ...
    public MToken insOperCd(String insOperCd) {
    ...
    public MToken insDateTime(ZonedDateTime insDateTime) {
    ...
    public MToken updOperCd(String updOperCd) {
    ...
    public MToken updDateTime(ZonedDateTime updDateTime) {
    ...
    public MToken version(Integer version) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MToken)) {
            return false;
        }
        return id != null && id.equals(((MToken) o).id);
    }
