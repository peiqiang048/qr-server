...
import com.cnc.qr.common.constants.ErrorConstants;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(EmailAlreadyUsedException ex,
        ...
        return create(problem, request, HeaderUtil
            .createFailureAlert(applicationName, true, problem.getEntityName(),
    ...
    public ResponseEntity<ApiError> handleBusinessException(BusinessException ex,
        ...
        ApiError apiError = apiErrorCreator
            .createResultMessagesApiError(request, ex.getResultCode(), ex.getResultMessages(),
                ex.getMessage());
    ...
    public ResponseEntity handleBusinessException(SystemException ex, NativeWebRequest request) {
        log.error(ex.getMessage(), ex);
        ApiError apiError = apiErrorCreator
            .createApiError(request, ex.getCode(), ex.getLocalizedMessage(), ex.getArgs());
        return new ResponseEntity(apiError, new HttpHeaders(), HttpStatus.OK);
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<ApiError> handleException(Exception ex, NativeWebRequest request) {
        log.error(ex.getMessage(), ex);
        ApiError apiError = apiErrorCreator.createApiError(request,
            CodeConstants.ResultCode.FAILED.getResultCode(),
            CodeConstants.ResultCode.FAILED.getMessage(), (Object) null);
        return new ResponseEntity(apiError, new HttpHeaders(), HttpStatus.OK);
    }
}
